        ...
        <section className="py-24 bg-background relative overflow-hidden" id="features">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(180px,auto)]">
                    {/* Feature 1: Natural Language (Large - Top Left) */}
                    <ScrollReveal delay={0.1} className="md:col-span-8 bg-background-card border border-border-color rounded-3xl p-8 relative overflow-hidden group hover:border-primary/50 transition-colors shadow-lg shadow-black/5">
                    ...
                    {/* Feature 2: OCR (Tall - Right Side) */}
                    <ScrollReveal delay={0.2} className="md:col-span-4 md:row-span-2 bg-gradient-to-br from-background-card to-background border border-border-color rounded-3xl p-8 relative overflow-hidden group hover:border-emerald-500/50 transition-colors shadow-lg shadow-black/5">
                        {/* Scan Animation Layer */}
                        <div className="absolute inset-x-0 h-[2px] bg-emerald-400/80 shadow-[0_0_20px_rgba(52,211,153,0.8)] z-20 animate-scan"></div>
                        <div className="absolute inset-0 bg-grid-white/[0.03] bg-[length:24px_24px]"></div>
                    ...
                    <ScrollReveal delay={0.3} className="md:col-span-4 bg-background-card border border-border-color rounded-3xl p-8 group hover:border-purple-500/50 transition-colors shadow-lg shadow-black/5 flex flex-col justify-between">
                    ...
                    {/* Feature 4: Analytics */}
                    <ScrollReveal delay={0.4} className="md:col-span-4 bg-background-card border border-border-color rounded-3xl p-8 group hover:border-orange-500/50 transition-colors shadow-lg shadow-black/5 flex flex-col justify-between">
                    ...
                    {/* Feature 5: Privacy (Wide Bottom) */}
                    <ScrollReveal delay={0.5} className="md:col-span-6 bg-background-card border border-border-color rounded-3xl p-6 flex items-center gap-6 group hover:border-gray-500/50 transition-colors shadow-lg shadow-black/5">
                    ...
                    {/* Feature 6: Export (Wide Bottom) */}
                    <ScrollReveal delay={0.6} className="md:col-span-6 bg-background-card border border-border-color rounded-3xl p-6 flex items-center gap-6 group hover:border-green-500/50 transition-colors shadow-lg shadow-black/5">
